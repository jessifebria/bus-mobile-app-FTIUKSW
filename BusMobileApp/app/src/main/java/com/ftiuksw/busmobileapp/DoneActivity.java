...
public class DoneActivity<adapter> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btndone.setBackgroundResource(R.drawable.bggray);
        ...
        btnupcoming.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DoneActivity.this, UpcomingActivity.class);
                startActivity(i);
            }
        });
    ...
    private class GetBook extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://10.0.2.2:8089/booking/done/"+nim;
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(DoneActivity.this, bookList,
